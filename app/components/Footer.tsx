    ...
    <footer className="fixed bottom-0 left-0 right-0 py-4 px-4 ">
      <div className=" flex justify-center">
        <div className="flex justify-center space-x-4 mb-3 p-2 rounded-lg opacity-80">
          ...
          >
            <FaGithub className="text-xl text-gray-800 hover:text-black transition duration-300" />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaLinkedin className="text-xl text-gray-800 hover:text-black transition duration-300" />
          </a>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaTwitter className="text-xl text-gray-800 hover:text-black transition duration-300" />
          </a>
        </div>
      </div>
    </footer>
